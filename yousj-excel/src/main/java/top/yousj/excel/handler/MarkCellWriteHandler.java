...
public class MarkCellWriteHandler implements CellWriteHandler {
    ...
    public void afterCellDispose(WriteSheetHolder writeSheetHolder, WriteTableHolder writeTableHolder, List<WriteCellData<?>> cellDataList, Cell cell, Head head, Integer relativeRowIndex, Boolean isHead) {
        FuncUtil.run(cell.getCellType() == CellType.STRING && StringUtils.isNotBlank(cell.getStringCellValue()), () -> Arrays.stream(ExcelUtil.Mark.values()).forEach(mark -> setCellMark(writeSheetHolder, cell, mark)));
    }
