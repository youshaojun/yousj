...
public class UrlCellWriteHandler implements CellWriteHandler {
    ...
    public void afterCellDispose(WriteSheetHolder writeSheetHolder, WriteTableHolder writeTableHolder, List<WriteCellData<?>> cellDataList, Cell cell, Head head, Integer relativeRowIndex, Boolean isHead) {
        FuncUtil.run(!isHead && cell.getColumnIndex() == columnIndex && !Objects.equals(cell.getStringCellValue(), ignoreStr), () -> setHyperlink(writeSheetHolder, cell, useDefaultCellValue, ignoreStr));
    }
