...
public class RedMarkCellWriteHandler implements CellWriteHandler {
	...
	public void afterCellDispose(WriteSheetHolder writeSheetHolder, WriteTableHolder writeTableHolder, List<WriteCellData<?>> cellDataList, Cell cell, Head head, Integer relativeRowIndex, Boolean isHead) {
		if (cell.getCellType() == CellType.STRING && StringUtils.isBlank(cell.getStringCellValue())) {
			setCellMark(writeSheetHolder, cell, ExportExcelUtil.Mark.RED);
		}
	}

	private void setCellMark(WriteSheetHolder writeSheetHolder, Cell cell, ExportExcelUtil.Mark mark) {
